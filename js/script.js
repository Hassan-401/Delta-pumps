...
window.DeltaPumpCart = (() => {
    const KEY = 'deltapump_cart';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    let currentLang = localStorage.getItem('deltapump_lang') || 'ar'; // Default Arabic

    const applyLanguage = (lang) => {
        const htmlEl = document.documentElement;
        currentLang = lang;
        localStorage.setItem('deltapump_lang', lang);
